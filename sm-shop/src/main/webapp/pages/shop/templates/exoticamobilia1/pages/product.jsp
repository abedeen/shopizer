...
<div id="shop" class="container" style="padding-left: 0px;">
	...
	<section class="main-container">
		...
		<div class="main col-md-12 no-right-padding" style="padding-left: 0px;">
			...
			<div class="row">
					...
					<!-- ul role="tablist" class="nav nav-pills white space-top">
						<li class="active"><a title="images" data-toggle="tab"
							role="tab" href="#product-images"> <i
								class="fa fa-camera pr-5"></i> <s:message
									code="label.generic.pictures" text="Pictures" />
						</a></li>
						<c:if test="${requestScope.VIDEO_URL!=null}">
							<li><a title="video" data-toggle="tab" role="tab"
								href="#product-video"> <i class="fa fa-video-camera pr-5"></i>
									<s:message code="label.generic.videos" text="Videos" />
							</a></li>
						</c:if>
					</ul-->
					<div class="col-md-4 tab-content clear-style">
								...
								<div style="width: 100%;" class="owl-item">
									<div id="largeImg" class="overlay-container image-container">
										<img src="<c:url value="${product.image.imageUrl}"/>"
											alt="<c:out value="${product.description.name}"/>"> <a
											href="<sm:shopProductImage imageName="${product.image.imageName}" sku="${product.sku}" size="LARGE"/>"
													...
													<c:choose>
														...
														<c:otherwise>
															<a href="javascript:;"
																...
																height="100" src="${thumbnail.externalUrl}"
						...
						</span> <c:if test="${not product.productVirtual}">
								<address>
					...
					<div class="col-md-8">
					<h1 class="shop-banner-title lead" style="width: auto;">${product.description.name}</h1>
					
					<div style="padding-left:45px"> <c:out value="${product.description.description}"
											escapeXml="false" /> </div>
					<h1><s:message code="label.productedit.productdesc"
												text="Product description" /></h1>
					</div>
					<div >
...
<div class="form-group col-md-4">
		...
		<input type="text" name="name" value="" maxlength="20" size="22" tabindex="1" class="">
</div>

<div class="form-group col-md-4">
		<label >E-mail (required, but will not display)</label>
		<input type="text" name="email" value="" size="22" tabindex="2" class="">
</div>
<div class="form-group col-md-12">
		<label >Website</label>
		<input type="text" name="homepage" value="" size="22" tabindex="3">
</div>
</div>

<div class="form-group">
		<textarea  name="comment" cols="65" rows="8" tabindex="5"></textarea><div class="grippie"><span class="counter"> <span>1000</span>  symbols left</span></div>
</div>
<div class="checkbox">
		<label >Notify me of follow-up comments</label>
		<input class="checkbox"  type="checkbox" name="subscribe" value="1" tabindex="5">		
</div>
<div class="form-group">
	<div class="form-inline">
		<div class="form-group">
			<img class="captcha"  src="#" width="121" height="60" alt="Security code"><br>
		</div>
		<div class="form-group">
			<span class="captcha">Refresh</span><br>
		</div>
		<div class="form-group">
			<input class="captcha"  type="text"  value="" size="5" tabindex="6"><br>
		</div>
	</div>					
</div>
<div class="form-group">
	<div>
		<a class="btn btn-default" href="#" tabindex="7" >Send</a>
	</div>
	<div  style="display:none;">
		<a class="btn btn-default" href="#" tabindex="8"  title="Cancel">Cancel</a>
	</div>
							...
							<div class="productItem tabs-style-2">
								...
								<ul role="tablist" class="nav nav-tabs">
									<li class="active"><a data-toggle="tab" role="tab"
										...
										<s:message code="label.productedit.productdesc"
												text="Product description" /></a></li>
									<li class=""><a data-toggle="tab" role="tab"
										href="#h2tab2" aria-expanded="false"><i
											class="fa fa-files-o pr-5"></i>
										<s:message code="label.product.attribute.specifications"
												text="Specifications" /></a></li>
									<li class=""><a data-toggle="tab" role="tab"
										href="#h2tab3"><i class="fa fa-star pr-5"></i>
								...
								<div class="tab-content padding-top-clear padding-bottom-clear">
									<div id="h2tab1" class="tab-pane fade  active in">
										...
										<c:if
											test="${product.manufacturer.code=='green' || product.manufacturer.code=='local'}">
										...
										<dl class="dl-horizontal">
											...
											<c:if test="${attributes!=null}">
												<c:forEach items="${attributes}" var="attribute"
													...
													<dd>
														<c:out value="${attribute.readOnlyValue.description}" />
													</dd>
												</c:forEach>
											</c:if>
										</dl>
			...
			<div class="container no-left-padding no-right-padding">
				<div class="row">
					<div class="col-md-12">
						...
						<jsp:include
							page="/pages/shop/templates/exoticamobilia/sections/productBox.jsp" />
					</div>
				</div>
			</div>
		</div>
		...
		$('.thumbImg')
				.click(
						function() {
							...
							$("#largeImg")
									.html(
											"<img src='" + url + "' /><a href='" + url + "' data-mfp-src='" + url + "' class='popup-img overlay' title='" + name + "'><i class='fa fa-search-plus'></i></a>");
							//re bind action
							$('.popup-img').magnificPopup({
								type : 'image'
							});
